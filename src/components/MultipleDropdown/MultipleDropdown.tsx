...
const MultipleDropdown: FC<MultipleDropdownProps> =({index, dropdownsInfo, setDropdownsInfo, active}) => {
  const initialReferrersState: referrerItem[] = [
    { title: 'Referrer 1', active: false },
    { title: 'Referrer 2', active: false },
    { title: 'Referrer 3', active: false },
    { title: 'Referrer 4', active: false },
  ]
  const [referrers, setReferrers] = useState<referrerItem[]>(initialReferrersState);
  ...
  return (
    <div
      ...
      } " absolute top-10 left-0 w-[189px] h-[200px] transition-all duration-500 z-10 bs-l-g-4-18`}
    >
      {referrers.map((item, index) => (
        <button
          ...
          } dropdownElem multiDropdown text-[#6E6B7B]  
          relative flex items-center justify-between w-[189px] h-[40px] text-left px-4`}
          style={{font: "var(--body-paragraph, 400 14px/21px 'Montserrat', sans-serif)"}}
        >
          {item.title}
          {item.active && (
            <svg
            ...
            >
              <path
                d="M13.8 5.13333L6.46667 12.4667C6.33333 12.6 6.2 12.6667 6 12.6667C5.8 12.6667 5.66667
                12.6 5.53333 12.4667L2.2 9.13333C1.93333 8.86667 1.93333 8.46667 2.2 8.2C2.46667 7.93333
                2.86667 7.93333 3.13333 8.2L6 11.0667L12.8667 4.2C13.1333 3.93333 13.5333 3.93333 13.8
                4.2C14.0667 4.46667 14.0667 4.86667 13.8 5.13333Z"
                fill="black"
              />
              <mask id="mask0_156_3018" maskUnits="userSpaceOnUse" x="2" y="4" width="12" height="9">
                <path
                  d="M13.8 5.13333L6.46667 12.4667C6.33333 12.6 6.2 12.6667 6 12.6667C5.8 12.6667 5.66667
                  12.6 5.53333 12.4667L2.2 9.13333C1.93333 8.86667 1.93333 8.46667 2.2 8.2C2.46667 7.93333
                  2.86667 7.93333 3.13333 8.2L6 11.0667L12.8667 4.2C13.1333 3.93333 13.5333 3.93333 13.8
